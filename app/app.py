...
/* FIX: override streamlit's global p/span/div color injection */
...
/* ── Hero ── */
.hero { text-align: center; padding: 110px 24px 80px; animation: fadeUp 0.9s ease both; }
@keyframes fadeUp { from { opacity:0; transform:translateY(24px); } to { opacity:1; transform:translateY(0); } }

.eyebrow {
    display: inline-flex; align-items: center; gap: 8px;
    background: rgba(14,165,233,0.08); border: 1px solid rgba(14,165,233,0.2);
    color: #38bdf8; padding: 6px 18px; border-radius: 100px;
...
/* FIX: missing opening paren in clamp */
.hero-h1 {
...
/* FIX: stat-l was invisible — was #6b7280 which blends into dark bg */
...
/* FIX: sec-p color was #3d4d5c — completely invisible on dark bg */
...
/* FIX: feat-p was #6b7280 — slightly brighter now */
...
/* FIX: cta-p was #3d4d5c — invisible on dark bg */
.cta-p { color: #7a8799; font-size: 0.95rem; line-height: 1.8; margin-bottom: 40px; font-weight: 300; }
.cta-btn {
    display: inline-flex; align-items: center; gap: 8px;
    background: linear-gradient(135deg, #0ea5e9, #6366f1);
...
div[data-testid="stButton"] button:hover {
    ...
    box-shadow: 0 0 60px rgba(14,165,233,0.5) !important;
}
</style>
...
# Streamlit CTA button — works properly with st.switch_page
